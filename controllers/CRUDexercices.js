...
async function deleteExercice (req,res){
  ...
  //Get get Exercices By tags 90% 
async function getExercicesBytags (req, res){
    try{
    // const  categories =  req.body.tags
    const a = await Exercice.find({ tags: "proba" })
  ...
  module.exports = { getAllExercices, addExercice, addNewUser, deleteExercice, getExercicesBytags  }